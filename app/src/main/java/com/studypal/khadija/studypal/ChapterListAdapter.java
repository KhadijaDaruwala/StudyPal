...
public class ChapterListAdapter extends CursorAdapter {
    ...
    public ChapterListAdapter(Context context, Cursor cursor, int flags, AdapterCallback callback) {
    ...
    public void bindView(View view, final Context context, final Cursor cursor) {
        ...
        title.setText(cursor.getString(cursor.getColumnIndex(DatabaseChapter.COLUMN_NAME)));
