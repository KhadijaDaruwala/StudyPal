...
import com.studypal.khadija.studypal.Scribble.Memo;
...
public class DatabaseStudyLogs extends SQLiteOpenHelper{
   ...
   // public static final String COLUMN_DATE = "date";
    ...
    public void addStudyLog(StudyLog studylog) {
        ...
        values.put(COLUMN_CHAPTER_NAME, studylog._chaptername);
        //values.put(COLUMN_DESCRIPTION, studylog.getDescription());
        values.put(COLUMN_DATE_TIME, studylog._datetime);
        //values.put(COLUMN_DATE, studylog.getDate());
        SQLiteDatabase db = this.getWritableDatabase();

        db.insert(TABLE, null, values);
        Log.d("addStudyLog", studylog._chaptername);
        Log.d("addStudyLog",studylog._datetime);
